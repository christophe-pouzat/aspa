...
int main()
{
  ...
  fp = fopen("locust20010214_Spontaneous_1_tetB_u1.baspa","w");
  aspa_sta_fwrite(fp,sta,false);
  fclose(fp);
  aspa_sta_free(sta);
  fp = fopen("locust20010214_Spontaneous_1_tetB_u1.baspa","r");
  sta = aspa_sta_fread(fp);
  fclose(fp);
